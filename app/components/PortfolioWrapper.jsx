...
export default function PortfolioWrapper({ initialMode = "developer" }) {
  ...
  // Initialize mode based on URL and localStorage
  useEffect(() => {
  ...
  // Save view preference to localStorage whenever mode changes
  useEffect(() => {
    if (isInitialized) {
